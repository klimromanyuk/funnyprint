...
## Known issue
При изменении вкладки Изображение/Текст не обновляется предпросмотр. Нажмите "Обновить" в предпросмотре. При печати, даже если в предпросмотре изображение, а выбрана вкладка с текстом - всё равно напечатается текст.
